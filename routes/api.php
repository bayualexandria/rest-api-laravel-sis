...
Route::middleware(['auth:sanctum'])->group(function () {
    Route::middleware(['isAdmin'])->group(function () {
        ...
        Route::controller(GuruController::class)->prefix('guru')->group(function () {
            ...
            Route::get('status-wali-kelas',  'dataGuruByStatusWaliKelas');
    ...
    Route::controller(SiswaController::class)->prefix('siswa')->group(function () {
        ...
        Route::get('kelas/{kelas}', 'getAllSiswaByKelas');
        Route::get('search', 'searchSiswa');
        Route::post('kelas', 'insertSiswaByKelas');
        Route::put('kelas/{id}', 'updateSiswaByKelas');
        Route::delete('kelas/{kelas}', 'deleteSiswaByKelas');
